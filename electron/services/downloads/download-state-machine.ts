...
const transitions: Record<PipelinePhase, ReadonlySet<PipelinePhase>> = {
  ...
  validating: new Set(['planning', 'promoting', 'failed', 'cancelled']),
  planning: new Set([
  ...
  promoting: new Set(['verifying', 'recovery-pending', 'failed']),
  verifying: new Set(['cataloging', 'ready', 'recovery-pending', 'failed']),
